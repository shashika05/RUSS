...
const ProjectCard = (props) => {
  return (
    <div className="border-2 flex flex-col items-center group rounded-xl text-center pb-7">
      ...
      <a
        ...
        className="text-textcolor border-b-2 border-[#6D2C95] hover:text-[#6D2C95] transition-all duration-300 ease-in-out mt-auto"
      >
