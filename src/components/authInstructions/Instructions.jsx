      ...
      <div className="border-b mb-4">
        ...
        >
          <p className="text-gray-700 pl-4 pb-4">
            ...
            Community projects conducted during the last two years (2022-2024).
          </p>
        </Transition>
      </div>
      ...
      <div className="border-b mb-4">
        ...
        >
          <div className="pl-4 pb-4 space-y-2">
            <p>
              1. Authors should submit the Author Information Form together with
              the manuscript.
            </p>
            <ul className="list-disc pl-6">
              <li>
                Abstract & Extended Abstract should be submitted in two separate
                files.
              </li>
              <li>
      ...
      <div className="border-b mb-4">
        ...
        >
          <div className="pl-4 pb-4 space-y-2">
            ...
            <ul className="list-disc pl-6">
              <li>
                Poster should be digitally printed with dimensions 120cm x 90cm
                (4 x 3 ft).
              </li>
      ...
      <div className="border-b mb-4">
        ...
        >
          <div className="pl-4 pb-4 space-y-2">
            <ul className="list-disc pl-6">
              <li>
                Submit the Registration Form, Author Declaration Form, and Bank
