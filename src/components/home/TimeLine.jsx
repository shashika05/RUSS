...
export default function TimeLine() {
  ...
  const timelineData = [
    ...
    },
    {
      ...
      ongoingProjects: ["Special 1", "Special 2", "Special 3"],
    ...
    <div>
      <div className="tim-container">
        ...
        {timelineData.map((item, index) => (
          <div
            key={index}
            className={`box ${index % 2 === 0 ? "box-left" : "box-right"}`}
          >
            <div className="info" style={{ border: "1px solid black" }}>
              ...
              {expandedItem === index && (
                <div className="additional-content">
                  {item.significantProjects &&
                    item.significantProjects.map((project, projectIndex) => (
